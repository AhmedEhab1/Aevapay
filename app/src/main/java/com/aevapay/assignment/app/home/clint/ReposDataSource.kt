package com.aevapay.assignment.app.home.clint

import android.util.Log
import androidx.lifecycle.MutableLiveData
import androidx.paging.PageKeyedDataSource
import com.aevapay.assignment.MyApp
import com.aevapay.assignment.app.home.database.RepoDao
import com.aevapay.assignment.app.home.models.Repo
import com.aevapay.assignment.app.home.network.ApiClient
        ...
        call?.enqueue(object : Callback<List<Repo>> {
            override fun onFailure(call: Call<List<Repo>>, t: Throwable) {
                ...
                try {
                    ...
                    callback.onResult(
                        MyApp.appDataBase.repoDao().getRepos().value!!,
                        null,
                        FIRST_PAGE + 1
                    )
                }catch (e : Exception){
